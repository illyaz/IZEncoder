namespace Sanford.Collections.Generic
{
    ...
    public partial class Deque<T>
    {
        ...
        private class SynchronizedDeque : Deque<T>, IEnumerable
        {
            ...
            public override bool TryPopFront(out T result)
            {
                lock (root)
                {
            ...
            public override bool TryPopBack(out T result)
            {
                lock (root)
                {
            ...
            public override bool TryPeekFront(out T result)
            {
                lock (root)
                {
            ...
            public override bool TryPeekBack(out T result)
            {
                lock (root)
                {
