namespace IZEncoder.AvisynthPlayer.SourceTouch
{
    ...
    public class SoundTouchInterop32
    {
        ...
        ///     Number of samples in buffer. Notice that in case of stereo-sound a single sample contains data
        ///     for both channels.
        /// </param>
        [DllImport(SoundTouchDllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void soundtouch_putSamples(IntPtr h, [MarshalAs(UnmanagedType.LPArray)] float[] samples,
            int numSamples);
        ...
        public static extern uint soundtouch_receiveSamples(IntPtr h,
            [MarshalAs(UnmanagedType.LPArray)] float[] outBuffer, uint maxSamples);
