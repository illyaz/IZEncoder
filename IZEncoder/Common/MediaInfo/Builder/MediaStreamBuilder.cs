...
namespace IZEncoder.Common.MediaInfo.Builder
{
    ...
    internal abstract class MediaStreamBuilder<TStream> : IMediaBuilder<TStream> where TStream : MediaStream, new()
    {
        ...
        /// <summary>
        ///     Gets the property <typeparamref name="T">value</typeparamref> by the
        ///     <paramref name="parameter">property name</paramref>.
        /// </summary>
        ...
        /// <returns>
        ///     Returns property <typeparamref name="T">value</typeparamref> of specified stream
        ///     <paramref name="parameter">property name</paramref>.
        /// </returns>
        ...
        /// <summary>
        ///     Gets the property <typeparamref name="T">value</typeparamref> by the
        ///     <paramref name="parameter">property index</paramref>.
        /// </summary>
        ...
        ///     <paramref name="parameter">property index</paramref>.
        /// </returns>
        protected T Get<T>(int parameter, InfoKind infoKind, ParseDelegate<T> convert,
            Func<string, string> extractResult = null)
        {
            if (convert == null) throw new ArgumentNullException(nameof(convert));
        ...
        protected string Get(string parameter, Func<string, string> extractResult = null)
        {
            ...
            if (extractResult != null) result = extractResult(result) ?? result;
