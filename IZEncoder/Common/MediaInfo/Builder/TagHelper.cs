namespace IZEncoder.Common.MediaInfo.Builder
{
    ...
    internal static class TagHelper
    {
        ...
        private static readonly List<Tuple<string, ParseDelegate<object>>> TagItems =
            new List<Tuple<string, ParseDelegate<object>>>
            {
        ...
        public static T GetAllTags<T>(MediaInfo mediaInfo, StreamKind kind, int streamPosition)
            where T : BaseTags, new()
        {
                ...
                cover != null)
            {
                ...
                var coverDescriptionItems =
                    ((string) coverDescription)?.Split(new[] {" / "}, StringSplitOptions.RemoveEmptyEntries);
                var itemCount = new[]
                {
                    coverDataItems?.Length ?? 0, coverTypeItems?.Length ?? 0, coverMimeItems?.Length ?? 0,
                    coverDescriptionItems?.Length ?? 0, coverItems?.Length ?? 0
                }.Max();
                if (itemCount > 0)
                {
                    var covers = new List<BaseTags.CoverInfo>(itemCount);
                    for (var i = 0; i < itemCount; ++i)
                    {
                        var data = coverDataItems.TryGet(i, string.Empty) ?? string.Empty;
                        covers.Add(new BaseTags.CoverInfo
                        {
                ...
                {
                    result.Covers = Enumerable.Empty<BaseTags.CoverInfo>();
                }
            }
            else
            {
        ...
        private static bool TryGetDate(string source, out object value)
        {
            ...
            var result = DateTime.TryParseExact(
                ...
                new[]
                {
                    ...
                    "UTC yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss.f", "yyyy-MM-dd HH:mm:ss.ff",
                    "yyyy-MM-dd HH:mm:ss.fff", "yyyy-MM-dd HH:mm:ss.ffff", "yyyy-MM-dd HH:mm:ss.fffff",
                    "yyyy/MM/dd", "yyyy/M/d", "yyyy/M/dd", "yyyy/M/d", "UTC yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm:ss",
                    "yyyy/MM/dd HH:mm:ss.f", "yyyy/MM/dd HH:mm:ss.ff", "yyyy/MM/dd HH:mm:ss.fff",
                    "yyyy/MM/dd HH:mm:ss.ffff", "yyyy/MM/dd HH:mm:ss.fffff",
                    "dd.MM.yyyy", "d.MM.yyyy", "dd.M.yyyy", "d.M.yyyy", "UTC dd.MM.yyyy HH:mm:ss",
                    "dd.MM.yyyy HH:mm:ss", "dd.MM.yyyy HH:mm:ss.f", "dd.MM.yyyy HH:mm:ss.ff", "dd.MM.yyyy HH:mm:ss.fff",
                    "dd.MM.yyyy HH:mm:ss.ffff", "dd.MM.yyyy HH:mm:ss.fffff",
                    "MM/dd/yyyy", "M/dd/yyyy", "MM/d/yyyy", "M/d/yyyy", "UTC MM/dd/yyyy HH:mm:ss",
                    "dd.MM.yyyy HH:mm:ss", "dd.MM.yyyy HH:mm:ss.f", "dd.MM.yyyy HH:mm:ss.ff", "dd.MM.yyyy HH:mm:ss.fff",
                    "dd.MM.yyyy HH:mm:ss.ffff", "dd.MM.yyyy HH:mm:ss.fffff"
                },
    ...
    internal static class ArrayExtensions
    {
        ...
        {
            if (index < 0) throw new ArgumentException($"Parameter {nameof(index)} is a negative value.");
