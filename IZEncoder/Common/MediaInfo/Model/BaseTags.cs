...
namespace IZEncoder.Common.MediaInfo
{
    ...
    public abstract class BaseTags
    {
        ...
        /// </value>
        public string[] Keywords => Tags.TryGetValue("Keywords", out var result)
            ? ((string) result).Split(new[] {','}, StringSplitOptions.RemoveEmptyEntries).Select(x => x.Trim())
            .ToArray()
            : null;
        ...
        /// <summary>
        ///     Gets a numeric value defining how much a person likes the song/movie. The number is between 0 and 5 with decimal
        ///     values possible (e.g. 2.7), 5(.0) being the highest possible rating.
        /// </summary>
        /// <value>
        ///     a numeric value defining how much a person likes the song/movie. The number is between 0 and 5 with decimal values
        ///     possible (e.g. 2.7), 5(.0) being the highest possible rating.
        /// </value>
