namespace IZEncoder.Common.MediaInfo
{
    ...
    public class VideoTags : BaseTags
    {
        ...
        public string ComposerNationality =>
            Tags.TryGetValue("Composer/Nationality", out var result) ? (string) result : null;
        ...
        public string AssistantDirector =>
            Tags.TryGetValue("AssistantDirector", out var result) ? (string) result : null;
        ...
        public string DirectorOfPhotography =>
            Tags.TryGetValue("DirectorOfPhotography", out var result) ? (string) result : null;
        ...
        public string ExecutiveProducer =>
            Tags.TryGetValue("ExecutiveProducer", out var result) ? (string) result : null;
        ...
        public string ProductionDesigner =>
            Tags.TryGetValue("ProductionDesigner", out var result) ? (string) result : null;
        ...
        public string EncodedApplication =>
            Tags.TryGetValue("Encoded_Application", out var result) ? (string) result : null;
        ...
        public string EncodedLibrarySettings =>
            Tags.TryGetValue("Encoded_Library/Settings", out var result) ? (string) result : null;
