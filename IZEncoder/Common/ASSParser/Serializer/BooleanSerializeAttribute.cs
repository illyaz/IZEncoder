namespace IZEncoder.Common.ASSParser.Serializer
{
    ...
    public sealed class BooleanSerializeAttribute : SerializeAttribute
    {
        ...
        /// <summary>
        ///     Whether <see cref="FormatException" /> will be thrown if the string doesn't match <see cref="TrueString" /> or
        ///     <see cref="FalseString" />.
        /// </summary>
        ...
        ///     <paramref name="value" /> doesn't match <see cref="TrueString" /> or
        ///     <see cref="FalseString" /> while <see cref="ThrowOnDeserializing" /> is true.
        /// </exception>
