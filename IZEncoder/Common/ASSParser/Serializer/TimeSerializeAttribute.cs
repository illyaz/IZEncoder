namespace IZEncoder.Common.ASSParser.Serializer
{
    ...
    public sealed class TimeSerializeAttribute : SerializeAttribute
    {
        ...
        public override string Serialize(object value)
        {
            ...
            return (va.Ticks / 36000000000).ToString(FormatHelper.DefaultFormat) +
                   va.ToString(@"\:mm\:ss\.ff", FormatHelper.DefaultFormat);
        }
        ...
        ///     <paramref name="value" /> is not a valid time string which is of an "h:mm:ss.ff"
        ///     format.
        /// </exception>
