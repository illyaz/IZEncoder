namespace IZEncoder.Common.ASSParser
{
    ...
    public class Style : Entry
    {
        ...
        [EntryField("Fontname")] private string fontName = "Arial";
        ...
        [EntryField("Fontsize")] private double fontSize = 12;
        ...
        [ColorSerialize] [EntryField("PrimaryColour")]
        ...
        [ColorSerialize] [EntryField("SecondaryColour")]
        ...
        [ColorSerialize] [EntryField("OutlineColour")]
        ...
        [ColorSerialize] [EntryField("BackColour")]
        private Color shadowColor;

        /// <summary>
        ///     The color of the shadow, which is displayed under the main text and offset by the shadow width defined to the
        ///     right.
        /// </summary>
        ...
        [EntryField("Bold")] private int bold;
        ...
        [EntryField("Italic")] private int italic;
        ...
        [EntryField("Underline")] private int underline;
        ...
        [EntryField("Strikeout")] private int strikeout;
        ...
        [EntryField("ScaleX")] private double scaleX = 100;
        ...
        [EntryField("ScaleY")] private double scaleY = 100;
        ...
        [EntryField("Spacing")] private double spacing;

        /// <summary>
        ///     Extra space between characters in pixels.
        /// </summary>
        /// <exception cref="ArgumentException">
        ///     <paramref name="value" /> is <see cref="double.IsNaN(double)" /> or
        ...
        [EntryField("Angle")] private double rotation;
        ...
        [EntryField("BorderStyle")] private int borderStyle = (int) BorderStyle.OutlineAndDropShadow;
        ...
        [EntryField("Outline")] private double outline;

        /// <summary>
        ///     If <see cref="BorderStyle" /> is <see cref="BorderStyle.OutlineAndDropShadow" />, this specifies the width of the
        ///     outline around the text in pixels.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="value" /> is less than 0.
        /// </exception>
        ...
        [EntryField("Shadow")] private double shadow;
        ...
        [EntryField("Alignment")] private int alignment = (int) AlignmentStyle.BottomCenter;
        ...
        [EntryField("Encoding")] private int encoding = 1;
        ...
        ///     This is only meaningful on Windows using VSFilter, where it is used to get some old(particularly Japanese) fonts
        ///     without proper Unicode mappings to render properly.
