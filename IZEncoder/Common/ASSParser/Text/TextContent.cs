namespace IZEncoder.Common.ASSParser
{
    ...
    public sealed partial class TextContent : IEquatable<TextContent>
    {
        ...
        /// </summary>
        public TextList Texts { get; private set; }
        ...
        private void init()
        {
            ...
            splitedTexts = stext.ToArray();
            Tags = new TagList(splitedTexts);
            Texts = new TextList(splitedTexts);
        }
        ...
        /// <summary>
        ///     Returns a new <see cref="TextContent" /> that replaced the text of <paramref name="index" /> of this
        ///     <see cref="TextContent" />.
        /// </summary>
        ...
        public TextContent ReplaceText(int index, string newText)
        {
            ...
            for (var i = 0; i < splitedTexts.Length; i++)
            {
                if (i == index)
        ...
        {
            return value == null ? null : new TextContent(value);
        }
