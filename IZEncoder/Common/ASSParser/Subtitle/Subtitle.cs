namespace IZEncoder.Common.ASSParser
{
    ...
    public static partial class Subtitle
    {
        ...
        {
            "; This file is generated by IZEncoder.Common.ASSParser",
            "; https://assloader.codeplex.com",
            ";"
        };

        internal static readonly EntryHeader DefaultStyleFormat = new EntryHeader(
            "Name,Fontname,Fontsize,PrimaryColour,SecondaryColour,OutlineColour,BackColour,Bold,Italic,Underline,Strikeout,ScaleX,ScaleY,Spacing,Angle,BorderStyle,Outline,Shadow,Alignment,MarginL,MarginR,MarginV,Encoding");

        internal static readonly EntryHeader DefaultEventFormat =
            new EntryHeader("Layer,Start,End,Style,Name,MarginL,MarginR,MarginV,Effect,Text");
            ...
            where TScriptInfo : ScriptInfoCollection
        {
            ...
            using (var reader = new StringReader(subtitle))
            {
                return await ParseAsync(reader, factory);
            }
        }
