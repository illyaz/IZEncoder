namespace IZEncoder.Common.ASSParser
{
    ...
    {
        AliceBlue = 0x00FFF8F0u,
        AntiqueWhite = 0x00D7EBFAu,
        Aqua = 0x00FFFF00u,
        Aquamarine = 0x00D4FF7Fu,
        Azure = 0x00FFFFF0u,
        Beige = 0x00DCF5F5u,
        Bisque = 0x00C4E4FFu,
        Black = 0x00000000u,
        BlanchedAlmond = 0x00CDEBFFu,
        Blue = 0x00FF0000u,
        BlueViolet = 0x00E22B8Au,
        Brown = 0x002A2AA5u,
        BurlyWood = 0x0087B8DEu,
        CadetBlue = 0x00A09E5Fu,
        Chartreuse = 0x0000FF7Fu,
        Chocolate = 0x001E69D2u,
        Coral = 0x00507FFFu,
        CornflowerBlue = 0x00ED9564u,
        Cornsilk = 0x00DCF8FFu,
        Crimson = 0x003C14DCu,
        Cyan = 0x00FFFF00u,
        DarkBlue = 0x008B0000u,
        DarkCyan = 0x008B8B00u,
        DarkGoldenrod = 0x000B86B8u,
        DarkGray = 0x00A9A9A9u,
        DarkGreen = 0x00006400u,
        DarkKhaki = 0x006BB7BDu,
        DarkMagenta = 0x008B008Bu,
        DarkOliveGreen = 0x002F6B55u,
        DarkOrange = 0x00008CFFu,
        DarkOrchid = 0x00CC3299u,
        DarkRed = 0x0000008Bu,
        DarkSalmon = 0x007A96E9u,
        DarkSeaGreen = 0x008FBC8Fu,
        DarkSlateBlue = 0x008B3D48u,
        DarkSlateGray = 0x004F4F2Fu,
        DarkTurquoise = 0x00D1CE00u,
        DarkViolet = 0x00D30094u,
        DeepPink = 0x009314FFu,
        DeepSkyBlue = 0x00FFBF00u,
        DimGray = 0x00696969u,
        DodgerBlue = 0x00FF901Eu,
        Firebrick = 0x002222B2u,
        FloralWhite = 0x00F0FAFFu,
        ForestGreen = 0x00228B22u,
        Fuchsia = 0x00FF00FFu,
        Gainsboro = 0x00DCDCDCu,
        GhostWhite = 0x00FFF8F8u,
        Gold = 0x0000D7FFu,
        Goldenrod = 0x0020A5DAu,
        Gray = 0x00808080u,
        Green = 0x00008000u,
        GreenYellow = 0x002FFFADu,
        Honeydew = 0x00F0FFF0u,
        HotPink = 0x00B469FFu,
        IndianRed = 0x005C5CCDu,
        Indigo = 0x0082004Bu,
        Ivory = 0x00F0FFFFu,
        Khaki = 0x008CE6F0u,
        Lavender = 0x00FAE6E6u,
        LavenderBlush = 0x00F5F0FFu,
        LawnGreen = 0x0000FC7Cu,
        LemonChiffon = 0x00CDFAFFu,
        LightBlue = 0x00E6D8ADu,
        LightCoral = 0x008080F0u,
        LightCyan = 0x00FFFFE0u,
        LightGoldenrodYellow = 0x00D2FAFAu,
        LightGreen = 0x0090EE90u,
        LightGray = 0x00D3D3D3u,
        LightPink = 0x00C1B6FFu,
        LightSalmon = 0x007AA0FFu,
        LightSeaGreen = 0x00AAB220u,
        LightSkyBlue = 0x00FACE87u,
        LightSlateGray = 0x00998877u,
        LightSteelBlue = 0x00DEC4B0u,
        LightYellow = 0x00E0FFFFu,
        Lime = 0x0000FF00u,
        LimeGreen = 0x0032CD32u,
        Linen = 0x00E6F0FAu,
        Magenta = 0x00FF00FFu,
        Maroon = 0x00000080u,
        MediumAquamarine = 0x00AACD66u,
        MediumBlue = 0x00CD0000u,
        MediumOrchid = 0x00D355BAu,
        MediumPurple = 0x00DB7093u,
        MediumSeaGreen = 0x0071B33Cu,
        MediumSlateBlue = 0x00EE687Bu,
        MediumSpringGreen = 0x009AFA00u,
        MediumTurquoise = 0x00CCD148u,
        MediumVioletRed = 0x008515C7u,
        MidnightBlue = 0x00701919u,
        MintCream = 0x00FAFFF5u,
        MistyRose = 0x00E1E4FFu,
        Moccasin = 0x00B5E4FFu,
        NavajoWhite = 0x00ADDEFFu,
        Navy = 0x00800000u,
        OldLace = 0x00E6F5FDu,
        Olive = 0x00008080u,
        OliveDrab = 0x00238E6Bu,
        Orange = 0x0000A5FFu,
        OrangeRed = 0x000045FFu,
        Orchid = 0x00D670DAu,
        PaleGoldenrod = 0x00AAE8EEu,
        PaleGreen = 0x0098FB98u,
        PaleTurquoise = 0x00EEEEAFu,
        PaleVioletRed = 0x009370DBu,
        PapayaWhip = 0x00D5EFFFu,
        PeachPuff = 0x00B9DAFFu,
        Peru = 0x003F85CDu,
        Pink = 0x00CBC0FFu,
        Plum = 0x00DDA0DDu,
        PowderBlue = 0x00E6E0B0u,
        Purple = 0x00800080u,
        Red = 0x000000FFu,
        RosyBrown = 0x008F8FBCu,
        RoyalBlue = 0x00E16941u,
        SaddleBrown = 0x0013458Bu,
        Salmon = 0x007280FAu,
        SandyBrown = 0x0060A4F4u,
        SeaGreen = 0x00578B2Eu,
        SeaShell = 0x00EEF5FFu,
        Sienna = 0x002D52A0u,
        Silver = 0x00C0C0C0u,
        SkyBlue = 0x00EBCE87u,
        SlateBlue = 0x00CD5A6Au,
        SlateGray = 0x00908070u,
        Snow = 0x00FAFAFFu,
        SpringGreen = 0x007FFF00u,
        SteelBlue = 0x00B48246u,
        Tan = 0x008CB4D2u,
        Teal = 0x00808000u,
        Thistle = 0x00D8BFD8u,
        Tomato = 0x004763FFu,
        Transparent = 0xFFFFFFFFu,
        Turquoise = 0x00D0E040u,
        Violet = 0x00EE82EEu,
        Wheat = 0x00B3DEF5u,
        White = 0x00FFFFFFu,
        WhiteSmoke = 0x00F5F5F5u,
        Yellow = 0x0000FFFFu,
        YellowGreen = 0x0032CD9Au
    }
