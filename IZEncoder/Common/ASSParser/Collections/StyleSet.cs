namespace IZEncoder.Common.ASSParser.Collections
{
    ...
    {
        private readonly HashSet<string> styleNameSet = new HashSet<string>(StringComparer.Ordinal);

        /// <summary>
        ///     Check whether the <see cref="Style" /> with the <see cref="Style.Name" /> is presented in the
        ///     <see cref="StyleSet" />.
        /// </summary>
        ...
        /// <param name="name">The <see cref="Style.Name" /> to look up.</param>
        /// <returns>
        ///     The index of the <see cref="Style" /> that the <see cref="Style.Name" /> is <paramref name="name" />, -1 if not
        ///     found.
        /// </returns>
