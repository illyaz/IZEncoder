namespace IZEncoder.UI.ViewModel.AvisynthParamUI
{
    ...
    public class StringAvisynthParamUIViewModel
        : AvisynthParamUIViewModelBase<StringAvisynthParamUI, StringAvisynthParamUIView>
    {
        public StringAvisynthParamUIViewModel(AvisynthParam param, StringAvisynthParamUI paramUI)
            : base(param, paramUI) { }
