namespace IZEncoder.UI.ViewModel.FFmpegParamUI
{
    ...
    public class StringOptionsFFmpegParamUIViewModel
        : FFmpegParamUIViewModelBase<StringOptionsFFmpegParamUI, StringOptionsFFmpegParamUIView>
    {
        public StringOptionsFFmpegParamUIViewModel(FFmpegParam param, StringOptionsFFmpegParamUI paramUI)
            : base(param, paramUI) { }
