namespace IZEncoder.UI.ViewModel.FFmpegParamUI
{
    ...
    public class FloatFFmpegParamUIViewModel
        : FFmpegParamUIViewModelBase<FloatFFmpegParamUI, FloatFFmpegParamUIView>
    {
        private bool _nudIsLeftDown;
        private Point _nudLastPoint;

        public FloatFFmpegParamUIViewModel(FFmpegParam param, FloatFFmpegParamUI paramUI)
            : base(param, paramUI) { }
